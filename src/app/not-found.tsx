    ...
    return (
        <div className="min-h-screen bg-white flex flex-col items-center justify-center relative overflow-hidden px-4">
            ...
            <div className="relative z-10 flex flex-col items-center text-center max-w-2xl mx-auto">
                ...
                <div className="mt-12 flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
                    <Link href="/" className="w-full sm:w-auto">
                        <Button className="w-full sm:w-auto bg-[#4640DE] hover:bg-[#3b36c0] text-white h-14 px-8 font-bold font-epilogue rounded-none shadow-lg shadow-[#4640DE]/20 group">
                            <Home className="mr-2 group-hover:-translate-y-0.5 transition-transform" size={18} />
                            Return Home
                        </Button>
                    </Link>
                    <Link href="/jobs" className="w-full sm:w-auto">
                        <Button variant="outline" className="w-full sm:w-auto h-14 px-8 border-zinc-200 text-[#2D2D2D] font-bold font-epilogue rounded-none hover:bg-zinc-50 group">
                            <Briefcase className="mr-2 group-hover:-translate-y-0.5 transition-transform" size={18} />
                            Browse Jobs
                        </Button>
                    </Link>
                </div>
                ...
                <p className="mt-12 text-[#515B6F] font-epilogue text-sm">
                    Think this is a mistake? <Link href="/contact" className="text-[#4640DE] font-bold hover:underline">Contact Support</Link>
                </p>
            </div>
            ...
            <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex items-center gap-2 text-zinc-300 pointer-events-none skew-x-12">
                ...
                <span className="font-clash text-xs uppercase tracking-[0.2em] font-bold">Quick Hire</span>
                <div className="h-px w-12 bg-zinc-200" />
            </div>
        </div>
    );
