...
const JobGridCard = ({ job }: JobGridCardProps) => {
  ...
  return (
    <div className="bg-white border border-zinc-100 p-6 flex flex-col gap-6 hover:border-[#4640DE]/50 hover:shadow-xl transition-all group font-epilogue h-full rounded-2xl">
      <div className="flex justify-between items-start">
        ...
        <div className="flex flex-col items-end gap-2">
          <span className="px-3 py-1 text-[10px] font-bold font-epilogue uppercase tracking-wider border border-[#4640DE] text-[#4640DE] bg-[#4640DE]/5 rounded-full">
      ...
      <div className="space-y-2">
        ...
        <p className="text-[#515B6F] text-sm font-medium flex items-center gap-2 flex-wrap">
      ...
      <div className="mt-auto pt-4 flex flex-col gap-3">
        ...
        <div className="flex items-center justify-between gap-4">
          <Link href={`/jobs/${job.id}`} className="grow">
            <Button className="w-full bg-[#4640DE] hover:bg-[#3b36c0] text-white font-bold font-epilogue py-5 shadow-lg shadow-[#4640DE]/20 cursor-pointer rounded-xl">
              View details
            </Button>
          </Link>
        </div>
