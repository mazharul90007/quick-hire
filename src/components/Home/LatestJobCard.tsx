...
const LatestJobCard = ({ job }: { job: Job }) => {
  ...
  return (
    <Link href={`/jobs/${job.id}`} className="block">
      <div className="bg-white p-6 flex lg:flex-row lg:items-center flex-col items-start gap-6 border border-zinc-100/50 hover:shadow-lg transition-all group font-epilogue cursor-pointer">
